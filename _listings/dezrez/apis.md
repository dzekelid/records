...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/records/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - Records an event on the role representing a neg being
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/records/master/_listings/dezrez/apieventrecordpropertyownercontact-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Records an event on the role representing a neg being
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/records/master/_listings/dezrez/apieventrecordownercontact-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Records an event on the role representing a neg being
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/records/master/_listings/dezrez/apieventrecordenquiry-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Records an event on the group representing a neg
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/records/master/_listings/dezrez/apigrouprecordcontact-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Records funds from office account into client account
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/records/master/_listings/dezrez/apireceiptfundsshortfall-post-openapi.md
x-common:
- type: x-github
